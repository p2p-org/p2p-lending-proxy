...
contract BaseMorphoUSDC is Test {
    ...
    function test_depositWithZeroDepositBpsRevertsAtPredict() public {
        vm.expectRevert(
            abi.encodeWithSelector(P2pYieldProxy__InvalidClientBasisPointsOfDeposit.selector, uint48(0))
        );
